...
class Camera:
    def __init__(self, width, height, initialPos = [0.0, 0.0, 4.0], initialFront = [0.0, 0.0, -2.0], initialUp = [0.0, 1.0, 0.0], bgColor=[0.1,0.1,0.1]):
        self.width = width
        self.height = height
    ...
    def get_view(self):
        ...
        # return glm.lookAt(glm.vec3(*self.pos), glm.vec3(0,0,0), glm.vec3(*self.up))
