...
class Renderer:
    def __init__(self, cord, mode, n):
        ...
        self.TranslatePoints = 0
        self.translation_location = glGetUniformLocation(self.shaderProgram, "transform")
    
    def translate(self):
        self.TranslatePoints += 0.01
        TranslationMatrix = Matrix44.from_translation([self.TranslatePoints, self.TranslatePoints, 0.0], dtype='float32')
        glUniformMatrix4fv(self.translation_location, 1, GL_FALSE, TranslationMatrix)
